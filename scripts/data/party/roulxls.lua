local character, super = Class(PartyMember, "roulxls")
...
function character:init()
    ...
    self:setActor("roulxls")
    --self:setLightActor("roulxls_lw")
    ...
    self.menu_icon = "party/roulxls/head"
    -- Path to head icons used in battle
    self.head_icons = "party/roulxls/icon"
    -- Name sprite
    self.name_sprite = "party/roulxls/name"
