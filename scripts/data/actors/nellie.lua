local actor, super = Class(Actor, "nellie")

function actor:init(style)
    super:init(self)

    local nellie_style = style or Game:getConfig("nellieStyle")
    ...
    self.hitbox = {14, 31, 19, 14}

    -- Color for this actor used in outline areas (optional, defaults to red)
    self.color = {1, 0, 1}

    -- Path to this actor's sprites (defaults to "")
    self.path = "party/nellie/dark"
    -- This actor's default sprite or animation, relative to the path (defaults to "")
    if nellie_style == 1 then
    ...
    self.animations = {
        ...
        -- Battle animations
        --["battle/intro"]         = {"battle/intro", 0.2, true},
